...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/Users/krhougs/LocalCodes/nostr-dump-worker/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/Users/krhougs/LocalCodes/nostr-dump-worker/.wrangler/tmp/bundle-YIEqIR/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/Users/krhougs/LocalCodes/nostr-dump-worker/.wrangler/tmp/bundle-YIEqIR/middleware-insertion-facade.js";
